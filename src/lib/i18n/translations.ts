...
const dict: Record<string, Record<UILang, string>> = {
  ...
  "nav.evaluations": { en: "Evaluations", no: "Evalueringer" },
  "nav.evaluationsDesc": { en: "Quality loop", no: "Kvalitetsloop" },
  ...
  "stats.evaluations": { en: "Editorial evaluations", no: "Redaksjonelle evalueringer" },
  "stats.evalCases": { en: "Eval cases", no: "Eval-caser" },
  "stats.evalRuns": { en: "Eval runs", no: "Eval-kjøringer" },
  "stats.evalApproved": { en: "Approved", no: "Godkjent" },
  "stats.evalAvgScore": { en: "Avg score", no: "Snittscore" },
  "stats.evalCost": { en: "Eval cost", no: "Eval-kostnad" },
  "stats.evalAcceptanceRate": { en: "Acceptance rate", no: "Godkjenningsrate" },
  "stats.evalQualityByModel": { en: "Evaluation quality by model", no: "Evalueringskvalitet per modell" },
  "stats.evalQualityByPrompt": { en: "Evaluation quality by prompt version", no: "Evalueringskvalitet per prompt-versjon" },
  "stats.noEvalRuns": { en: "No evaluation runs yet.", no: "Ingen evalueringskjøringer ennå." },
  ...
  "evaluations.section": { en: "Evaluations", no: "Evalueringer" },
  "evaluations.title": { en: "Editorial quality loop", no: "Redaksjonell kvalitetsloop" },
  "evaluations.description": {
    en: "Create repeatable eval cases, run them against a writer prompt version, and capture automated review plus human verdicts.",
    no: "Opprett repeterbare evalueringscaser, kjør dem mot en writer-prompt-versjon, og fang automatisk vurdering pluss redaksjonell dom.",
  },
  "evaluations.createCase": { en: "Create evaluation case", no: "Opprett evalueringscase" },
  "evaluations.caseName": { en: "Case name", no: "Case-navn" },
  "evaluations.researchLabel": { en: "Evaluation research", no: "Evalueringsresearch" },
  "evaluations.researchMaterial": { en: "Research material (optional)", no: "Researchmateriale (valgfritt)" },
  "evaluations.criteria": { en: "Quality criteria (optional)", no: "Kvalitetskriterier (valgfritt)" },
  "evaluations.expectedNotes": { en: "Expected editorial notes (optional)", no: "Forventede redaksjonelle notater (valgfritt)" },
  "evaluations.saveCase": { en: "Save case", no: "Lagre case" },
  "evaluations.promptVersion": { en: "Writer prompt version", no: "Writer prompt-versjon" },
  "evaluations.cases": { en: "cases", no: "caser" },
  "evaluations.runs": { en: "runs", no: "kjøringer" },
  "evaluations.empty": { en: "No evaluation cases yet. Create the first case to start measuring quality.", no: "Ingen evalueringscaser ennå. Opprett første case for å begynne å måle kvalitet." },
  "evaluations.run": { en: "Run eval", no: "Kjør eval" },
  "evaluations.running": { en: "Running…", no: "Kjører…" },
  "evaluations.latestScore": { en: "Latest score", no: "Siste score" },
  "evaluations.noRuns": { en: "No runs for this case yet.", no: "Ingen kjøringer for denne casen ennå." },
  "evaluations.generatedArticle": { en: "Generated article", no: "Generert artikkel" },
  "evaluations.approve": { en: "Approve", no: "Godkjenn" },
  "evaluations.reject": { en: "Reject", no: "Avvis" },
  "evaluations.approved": { en: "Approved", no: "Godkjent" },
  "evaluations.rejected": { en: "Rejected", no: "Avvist" },
  "evaluations.needsWork": { en: "Needs work", no: "Trenger arbeid" },
